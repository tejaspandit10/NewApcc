...
export const ApplyForm: React.FC = () => {
  ...
  const handleSectorChange = (sector: string) => {
    ...
    if (current.includes(sector)) {
      setFormData((prev) => ({
        ...prev,
        preferredSector: current.filter((s) => s !== sector),
      }));
    } else {
      setFormData((prev) => ({
        ...prev,
        preferredSector: [...current, sector],
      }));
    }
  };
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
        <div className="bg-[#003366] p-8 text-white text-center">
          ...
          <p className="text-cyan-200 font-medium">
            नोंदणी व करिअर उद्दिष्ट प्रश्नावली
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-12">
            ...
            <div className="mt-8 pt-8 border-t border-slate-100">
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                <div className="max-w-md">
                  <label className={`${labelClass} text-blue-900`}>
                    Agent Code (एजंट कोड) - If any
                  </label>
                  <input
                    name="agentCode"
                    onChange={handleInputChange}
                  ...
                  <p className="text-[10px] text-slate-500 mt-2">
                    Enter the agent code provided by your consultant or partner.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-6 border-b-2 border-slate-100 pb-4">
              ...
              <h2 className={sectionTitleClass}>
                EDUCATIONAL DETAILS (शैक्षणिक माहिती)
              </h2>
            </div>
            <div className="overflow-x-auto rounded-xl border border-slate-200">
              <table className="w-full text-sm border-collapse">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="p-4 text-left border-b text-[#003366] font-bold">
                      Qualification
                    </th>
                    <th className="p-4 text-left border-b text-[#003366] font-bold">
                      Passing Year
                ...
                <tbody>
                  {formData.education?.map((row, idx) => (
                    ...
                    >
                      <td className="p-4 border-b font-semibold bg-slate-50/50 text-slate-800">
                        {row.qualification}
                      </td>
                      <td className="p-2 border-b">
                        <input
                          type="text"
                          placeholder="Year"
                          className="w-full p-2 bg-transparent outline-none text-black focus:bg-white"
          ...
          <section>
            <div className="flex items-center gap-3 mb-6 border-b-2 border-slate-100 pb-4">
              ...
              <h2 className={sectionTitleClass}>
                CAREER INFORMATION (करिअर संबंधित माहिती)
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className={labelClass}>
                  Preferred Job Sector (कोणत्या क्षेत्रात नोकरी हवी आहे?)*
                </label>
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {sectors.map((sector) => (
                    <label
                      key={sector}
                      className="flex items-center gap-2 text-sm cursor-pointer hover:bg-slate-50 p-1.5 rounded text-slate-800 transition-colors"
                    >
                      <input
                        type="checkbox"
              ...
              <div>
                <label className={labelClass}>
                  Preferred Job Type (नोकरीचा प्रकार)*
                </label>
                <div className="grid grid-cols-2 gap-4 mt-2">
                  {[
                    ...
                    <label
                      key={type}
                      className="flex items-center gap-2 text-sm cursor-pointer text-slate-800 p-1.5 hover:bg-slate-50 rounded transition-colors"
                    >
                      <input
                        type="radio"
                        required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              <div>
                <label className={labelClass}>
                  Career Goal (आपले करिअर गोल काय आहेत?)*
                </label>
                <textarea
                  required
                  name="careerGoal"
                  ...
                  onChange={handleInputChange}
                  className={inputClass}
                  placeholder="Explain your professional aspirations..."
                ></textarea>
              </div>
              <div>
                <label className={labelClass}>
                  Skills / Experience (कौशल्य / अनुभव)*
                </label>
                <textarea
                  required
                  name="skills"
                  ...
                  onChange={handleInputChange}
                  className={inputClass}
                  placeholder="List your technical skills and practical experience..."
                ></textarea>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div>
                <label className={labelClass}>
                  English Proficiency (इंग्रजी ज्ञान)*
                </label>
                <select
                  required
              ...
              <div>
                <label className={labelClass}>
                  Expected Monthly Salary (अपेक्षित मासिक पगार)*
                </label>
                <input
                  required
                  type="number"
              ...
              <div>
                <label className={labelClass}>
                  Preferred Job Location (नोकरीचे ठिकाण)*
                </label>
                <input
                  required
                  type="text"
                  ...
                  onChange={handleInputChange}
                  className={inputClass}
                  placeholder="e.g. Pune, Mumbai, All India"
                />
              </div>
            </div>

            <div className="mt-8 bg-slate-50 p-8 rounded-2xl border border-slate-200">
              <label className={`${labelClass} mb-4 text-base`}>
                Previous Work Experience (आधी काम केले आहे का?)*
              </label>
          ...
          <section className="bg-cyan-50/50 p-8 rounded-2xl border border-cyan-100">
            ...
            <div className="max-w-md">
              <label className={labelClass}>
                Upload Resume (रिज्युमे अपलोड करा)
              </label>
          ...
          <section className="bg-slate-50 p-10 rounded-2xl border-2 border-dashed border-slate-300">
            <div className="flex items-center gap-3 mb-8">
              <span className="bg-[#003366] text-white w-8 h-8 rounded-full flex items-center justify-center font-bold">
                5
              </span>
              <h2 className={sectionTitleClass}>
                SELF-DECLARATION (जाहिरनामा)
              </h2>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 mb-8">
              <div className="flex items-start gap-4">
                ...
                <label
                  htmlFor="self-dec"
                  className="text-sm text-slate-700 leading-relaxed cursor-pointer font-medium select-none"
                >
                  ...
                  <span className="text-[10px] text-slate-500 mt-1 block">
                    (मी याद्वारे घोषित करतो/करते की वरील सर्व माहिती माझ्या
                    माहितीनुसार सत्य आणि अचूक आहे.)
                  </span>
                </label>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className={labelClass}>
                  Applicant Signature (Full Name / सही)*
                </label>
                <input
                  required
                  name="signature"
          ...
          <div className="bg-[#003366]/5 p-8 rounded-2xl border-2 border-slate-200">
            <div className="flex items-start gap-4">
              ...
              <label
                htmlFor="terms-check"
                className="text-sm font-bold text-[#003366] cursor-pointer select-none"
              >
                I agree to the{" "}
                <button
                  type="button"
                ...
                and <span className="text-red-600">No-Refund Policy</span>.
          ...
          <div className="flex flex-col items-center gap-6 pt-10 border-t-2 border-slate-100">
            <div className="text-center space-y-1">
              ...
              <p className="text-sm text-slate-600">
                Verify all details before submitting. Incomplete forms may be
                rejected.
              </p>
            </div>
            <button
